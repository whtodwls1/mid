...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
    ...
    if (nowGrp >= 2){ 
      str.append("<span class='span_box_1'><A href='./list.do?col="+col+"&word="+word+"&nowPage="+_nowPage+"&categoryno="+categoryno+"'>이전</A></span>"); 
    } 
    ...
    if (nowGrp < totalGrp){ 
      str.append("<span class='span_box_1'><A href='./list.do?col="+col+"&word="+word+"&nowPage="+_nowPage+"&categoryno="+categoryno+"'>다음</A></span>"); 
    } 
    str.append("</DIV>"); 
