...
function checkId_res(data){
  ...
  // alert('cookie: ' + $.cookie('checkId'));
}

function send(){
  var check = $.cookie('checkId'); // Cookie 값 읽기
  if (check != 'PASS'){
    $('#panel_id').css('color', '#FF0000');
...
<DIV class='content'>
  <FORM name='frm' method='POST' action='./create.do'
    ...
    <div class="form-group">   
      ...
      <div class="col-xs-9">
        <input type='text' name='id' id='id' value='' required="required"  placeholder="${id }">
    ...
    <div class="form-group">   
      <label for="title" class="col-xs-3 control-label">패스워드</label>
      <div class="col-xs-9">
