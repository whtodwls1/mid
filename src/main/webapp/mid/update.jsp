  ...
  <DIV class='content' style='width: 100%;'>
    <FORM name='frm' method='POST'  action='./update.do'
      ...
      <div class="form-group">   
        ...
        <div class="col-xs-10 ">
          <input type='text' class="form-control input-lg" name='midtitle' id='midtitle' value='${vo.midtitle}' size='60' required="required">
        </div>
      </div>   
       <div class="form-group">   
     ...
     <div class="form-group">   
      ...
      <div class="form-group">   
        ...
        <div class="col-xs-10">
          <textarea class="form-control input-lg" name='midcontent' id='midcontent'  rows='10' cols='70' >${vo.midcontent}</textarea>
        </div>
      </div>
         <div class="form-group">   
        <label for="title" class="col-xs-2 control-label">가격</label>
        <div class="col-xs-10 ">
          <input type='text' class="form-control input-lg" name='price' id='price' value='1000' size='60'  value="${vo.price}"required="required">
        </div>
      </div> 
        <div class="form-group">   
        <label for="title" class="col-xs-2 control-label">시청일</label>
        <div class="col-xs-10 ">
          <input type='text' class="form-control input-lg" name='watch' id='watch' value='1' size='60'  value= "${vo.watch }"required="required">
        </div>
      </div> 
      
      <DIV style='text-align: right;'>
        <button type="submit">등록</button>
        <button type="button" onclick="location.href='./list.do?midnum=${vo.midnum}'">취소[목록]</button>
      </DIV>
    </FORM>
  </DIV>
